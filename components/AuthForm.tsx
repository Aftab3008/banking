                ...
                render={({ field }) => (
                    <div className="form-item">
                        ...
                        <div className="flex w-full flex-col">
                            <FormControl>
                                <Input {...field} type="email" id="email" placeholder="Enter your email" className="input-class"/>
                            </FormControl>
...
<FormField
                ...
                render={({ field }) => (
                    <div className="form-item">
                        <FormLabel htmlFor="email" className="form-label">Password</FormLabel>
                        <div className="flex w-full flex-col">
                            <FormControl>
                                <Input {...field} type="password" id="email" placeholder="Enter your password" className="input-class"/>
                            </FormControl>
                        <FormMessage {...field} className="form-message mt-2"/>
                        </div>
                    </div>
